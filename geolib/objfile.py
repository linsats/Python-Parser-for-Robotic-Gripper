...
class OBJ(object):
  def __init__(self, vertices=None, faces=None, vnormals=None, normal_normalized=False,normalize=False,file_name=None,scale=1.0,rotation_degree=0):
    self.vertices = None
    self.faces = None 
    self.vnormals = None
    self.fnormals = None
...
if __name__ == "__main__":
  ...
  test = OBJ(file_name="/home/lins/MetaGrasp/grippers/meshes/robotiq_3f/coupling.obj",rotation_degree=0.0,normalize=False,normal_normalized=False)
  test.vertices *= 1.16#-= test.centers()
  #test.cal_vnormals()
  ...
  #plot_origin()
  #mayalab.show()
  test.write('link_3.0_tip_new.obj')
